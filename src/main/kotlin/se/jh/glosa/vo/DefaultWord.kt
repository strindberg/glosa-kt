...
import se.jh.glosa.fw.ALT_SEPARATOR
import se.jh.glosa.fw.HISTORY_SEPARATOR
import se.jh.glosa.fw.SEPARATOR

data class DefaultWord(val foreignWord: String, val localWord: String) : Word {
    ...
    override fun provideHistoryLine(): String {
        return "$foreignWord $SEPARATOR $localWord $HISTORY_SEPARATOR" + noOfUsedHist +
                HISTORY_SEPARATOR + noOfCorrect + HISTORY_SEPARATOR + noOfUsedHistInverse +
                HISTORY_SEPARATOR + "$noOfCorrectInverse\n"
    }
